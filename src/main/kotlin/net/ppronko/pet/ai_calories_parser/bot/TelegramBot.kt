    ...
    private fun handleCallback(update: Update) {
        ...
        when (data) {
            ...
            ProfileKeyboard.SET_MANUAL_GOALS -> {
                profileStateToSet = UserState.PROFILE_AWAITING_MANUAL_GOALS
        ...
        if (mealCallbackData != null) {
            when (mealCallbackData.type) {
                ...
                "meal_edit_item" -> {
                    ...
                    user.state = UserState.MEAL_AWAITING_AI_ITEM_EDIT
                    user.editingContext = "$sessionId:$itemIndex"
